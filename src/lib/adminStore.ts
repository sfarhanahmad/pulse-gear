...
const DEFAULT_SITE_CONTENT: SiteContent = {
  ...
  aboutStory: [
    ...
    'Every product in our catalog is personally tested by our team. We only sell what we\'d happily use ourselves. Orders are placed through WhatsApp for a fast, personal experience.',
  ],
  aboutValues: [
...
export function saveSiteContent(content: Partial<SiteContent>): void {
  localStorage.setItem(SITE_CONTENT_KEY, JSON.stringify({ ...getSiteContent(), ...content }))
