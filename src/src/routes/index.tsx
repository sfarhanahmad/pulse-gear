...
function HomePage() {
  ...
  return (
    <main>
      ...
      >
        ...
        <div className="relative z-10 text-center px-4 max-w-4xl mx-auto">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <a href="#products" className="bg-yellow-400 hover:bg-yellow-300 text-black font-bold px-8 py-4 rounded-xl text-lg transition-colors">
              Shop Now
            </a>
            <a href={waLink} target="_blank" rel="noopener noreferrer" className="border border-white/20 hover:border-white/50 text-white font-bold px-8 py-4 rounded-xl text-lg transition-colors">
              Chat on WhatsApp
            </a>
          </div>
        </div>
      ...
      {watches.length > 0 && (
        <section id={earbuds.length === 0 ? 'products' : undefined} className="max-w-6xl mx-auto px-4 py-20">
          <div className="mb-12">
